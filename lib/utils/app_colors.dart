...
class AppColors{
  ...
  static const Color colorBADEFB = Color(0xFFBADEFB);
  ...
  static Color backshadoColor = const Color(0xFFE8EBF0);
  static Color ColorDFDEDE = const Color(0xFFDFDEDE);
  ...
  static Color likeColor = const Color(0xFF0019FE);
